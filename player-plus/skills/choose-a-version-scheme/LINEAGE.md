...
credits:
  - "understand semver if you need it; otherwise incrementing integers, dates, or dates with a serial, usually with a v prefix; v-tags, VERSION and CHANGES files; no future features pinned to version numbers — the pkai-starter-kit practice"
