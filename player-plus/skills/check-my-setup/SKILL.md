...
4. **A review surface.** Ask what they use to read and edit markdown. None: point at the review surfaces in the kit's `REQUIREMENTS.md` (Typora, MarkText, MeetingWords; Obsidian or VS Code are fine if already in use). The terminal isn't meant to be their reading room.
