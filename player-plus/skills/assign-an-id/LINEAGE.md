...
credits:
  - "the board handle `yymmdd-aa`, the rule that an allocated codename is computed and never reused, session-log naming, and namespaced immutable identifiers in the SPDX style — all from the pkai-starter-kit practice"
