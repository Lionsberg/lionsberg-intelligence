...
**Present by number, and point only at what matters.** Show the candidates as #1, #2, #3, etc., in the order generated. Say briefly how they differ ("#1–#3 vary the palette; #4 tries a centered layout") and offer a view of your own ("#2 handles the lettering best"). Don't narrate every image in detail — your person can see them. Your job is to point at the differences that matter and help them choose.
