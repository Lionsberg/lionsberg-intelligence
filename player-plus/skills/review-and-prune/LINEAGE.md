...
credits:
  - "the review rhythm; the promotion rule (was I re-applying this in nearly every session, whatever the context?); and the layering harness > charter > memory > conversation — the PKAI network"
