...
> 2. Beside each name write one line in your own words: what you would say to them. *Here is a story, here is a game, and here is a flame* is enough.
> 3. Send one of them the whole of it today: the Story, the Game, and this move. Not a summary and not a pitch.
> 4. Write the date you sent it. When they answer, write what they said, whichever way it went.
>
> **With a notebook:** the same list on one page, kept where you will see it at your next gathering.
>
> **You will know it worked when** the names are written down and one of those people is holding the whole of it.
...
6. **Sit with them for their first week, if they ask.** Be there for their first gathering if they want you there. Then step back. A companion, never an authority.
7. **Let their table be their own.** Not a branch of yours, not a sub-committee, not a chapter. A new and complete body, carrying the whole pattern, in their own voice, with their own people, in their own place. You are their **Carrier**: the one who brought them the Flame, which never changes, whatever happens afterward. And your Cell is their first [home](Lexicon.md) until they find another: the body that hears their season, keeps a copy of their pages, and comes when something is wrong. Expect nothing upward. No share, no obedience, no branch. Being someone's Carrier is a relationship and never an authority over them.
8. **Write it down.** Count what you passed on [the Scorecard](Lexicon.md). Name the new Cell on your page at the turning, and let their page name you. If someone joins your own table instead of starting their own, write beside their name who brought them in, and leave it there forever. There is no register anywhere and no center keeping a list. What holds thousands of tables together is exactly this: each table knows who carried it, and each person knows who carried them, so the whole tree can be walked in either direction by anybody, from either end.
9. **Notice that you are now in two bodies.** The table that received you, and the table you helped begin. Everyone who does this is a link between the two, carrying the whole pattern in both. That is the shape by which the thing actually spreads, and it is not delegation and not recruitment. It is the oldest pattern there is, which is a living thing reproducing itself.
...
Nothing is wrong. Both answers are right, the friendship is unchanged, and the offer stays open. People come in their own time, and the ones who come that way stay.

## Where players stumble

- **Waiting to feel qualified.** Your table does not have to be running well for someone else to want to begin. What you have already is enough to hand over.
- **Passing a summary.** A clever short telling makes watchers. The whole seed makes players, because everything they need to start is in their hands and nothing depends on you.
- **Keeping the new table as a branch.** The moment it reports to you, it stops being a complete body and you have built a small empire. The only thing you keep is the line that says you carried them.
...
---
← [Play the Game](19%20Play%20the%20Game.md) · [Player+ Modules: Start Here](Player%2B%20Modules%20%E2%80%94%20Start%20Here.md) · [Structuring a Cell](17%20Structuring%20a%20Cell%20%E2%80%94%20LI%C3%98NSBERG%20FSx.md) →
