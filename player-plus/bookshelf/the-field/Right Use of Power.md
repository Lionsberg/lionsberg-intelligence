...
Its marks are recognizable in practice: power exercised inside a named [[Domain]]; reasoning visible; the smallest effective instrument chosen ([[Proportionality]]); the wielder answerable and replaceable; and force, where it is ever used, held to the minimum necessary to restore right relationship. Its distortions are equally recognizable — power used to protect its own position, power used because it is available, power exercised where consent was never sought.

In play, most players meet this as a host, a keeper, or an elder: the small daily question of whether a thing is mine to do, and whether doing it serves the table or my standing at it.

**Also called:** Just-Force Using
