...
A Player+ uses it in both directions. When you need a person, take the nearest door and ask. When someone needs you, remember that being asked is not an interruption of the Game; it is the Game. A sponsor walks beside a newcomer through their first season as a companion and a door, never an authority.

An agent may help a person find the right door and may draft the message. It does not stand in for the person at the other end, and the whole point of the list is that it ends with a human.
