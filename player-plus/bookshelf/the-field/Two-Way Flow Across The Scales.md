...
pillar: —
---
# Two-Way Flow Across The Scales

*What flows down must also flow up. A body that only flows downward becomes a hierarchy with no feedback; one that only flows upward becomes a chaos with no coordination.*

Both chains are enumerated rather than gestured at, which is what makes this an instrument.

**Downward**: from the wider tradition to those positioned to receive it; from the planetary council to the bioregional councils, who translate it into guidance for their regions; from the bioregional to the community councils, who localise it; from the community council to the coordinators of each body; from each body to its members, through gathered practice and witnessing; and from each member into their own daily disciplines, where everything received is finally incarnated or is not ([[Transmission]], [[Guidance]], [[The Daily Way]]).

**Upward**: from each member to their body — what they are noticing, what is arising, what needs the body's attention; from the body to the community council — what it is holding, what specialised work it is doing, what it is asking for; from the community to the bioregional council — what it is observing, and what larger pattern is visible from where it stands; from the bioregion to the planetary council; and from the planet outward — contributions reported, learnings shared, guidance requested ([[Requests and offers]], [[Live log]], [[Check In]]).
