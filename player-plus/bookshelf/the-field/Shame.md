...
The Body's structures address it directly. Cause is sought in the set-up rather than in the person ([[Zero Blame Environment]]). The gap between what was promised and what was done is treated as the primary source of learning, and is reported without blame. [[Every Defect Is A Gift]] means the one who names a miss is doing the Body a service rather than confessing a fault. [[Apologizing]] gives a clean move for genuine wrong, so that repair has a shape and does not require humiliation.

Humiliation deserves its own line. It is not an emotion a Body may use. Shaming as an instrument of correction produces silence, not change, and the Pattern's refusal of coercion reaches it.

The discipline remains: feel fully, read accurately, respond to what is reported — and where what is reported is a real wrong, repair it and let the shame go.

**Also called:** Embarrassment · Humiliation · Self-Consciousness
