...
It is also what gives the [[Meta]] move its meaning. At the top of every holarchy — of goals, ideals, values, categories — stands its Meta level, ultimately ineffable, where the category rejoins ØNE. Stepping up a level is not an escape from specifics; it is the acknowledgement that the specifics were always renderings.

In play it appears as a discipline of speech rather than a doctrine: nothing here is called canonical or final, a draft is cited as a draft, and the top rung is held with the most open hands of all.
