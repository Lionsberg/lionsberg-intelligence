...
pillar: —
---
# The LIØNSBERG Rosetta Stone

*One welcome and one description, carried into every language and back — the floor under "translate the words, keep the line order".*
...
And it is meant to grow well past a greeting. The ambition recorded with it is that all the wisdom, knowledge and solutions be locally and culturally translated — which is more than rendering sentences. It means the Pattern arrives in each place in that place's own idiom, images, and seasons, while remaining recognisably the same Pattern ([[General Pattern, Specific Application]], [[Cosmic Locality]], [[Meta Unity of Meta Diversity]]).

**Also called:** the Rosetta Stone
