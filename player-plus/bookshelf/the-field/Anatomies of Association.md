...
*Four things appear whenever sovereign beings associate on purpose: a domain, a membrane, a field of agreements, and a commons. They are not features added to a group; they are what a group that holds together is made of.*

**[[Domain]]** — the area of life or work the association takes on. What it is for, said plainly enough that someone can tell whether a given piece of work belongs to it.

**Membrane** — the boundary, crossed only by continuing mutual consent. Not a wall: something that filters, honours the sovereignty on both sides, and can be opened ([[Selectively Permeable Membrane]], [[Guard the Membrane]], [[Boundary]]).

**[[Field of Agreements]]** — the explicit covenants that govern how members relate inside. Explicit is the load-bearing word; every group has agreements, and the unwritten ones are the ones that go wrong ([[Agreement]], [[Higher Order Agreements]]).

**[[Commons]]** — the shared thing the association builds and tends. What it carries together, and what it will have to pass on ([[Commons-Tending]], [[Knowledge as commons]]).
