...
*The study of how we know, what can be known, and how we come to know rightly — the discipline behind [[Current Best Understanding]].*

Epistemology is where this Field is least willing to bluff. Its central move is to make the status of every claim explicit. Everything below [[The Goal]] is current best understanding, held openly, expected to change; the *why* is invariant, every *how* is revisable. [[Current Best Articulation]] names a second gap — between what is understood and the words available for it — and [[Essences, Renderings, And Ineffable Referents]] holds both gaps open on purpose. Nothing here is called canonical or final.
