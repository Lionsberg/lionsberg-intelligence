...
*The naming of what a body will not carry — because in living and social systems the quality of existence is largely determined by what gets tolerated.*
...
And it has to be bounded, or it becomes the thing it was guarding against. Three boundaries keep it honest. It applies to **named conduct**, written down in advance, not to a mood about someone ([[Rules of Participation]] · [[Agreement]] · [[We The People]]). It runs through **due process** — heard, answered, with recourse — rather than by exclusion on the spot ([[Recourse]] · [[Adjudication]] · [[Arbitration]] · [[Sanction]]). And it is held **beside respect for the person**, whose dignity does not depend on their conduct being acceptable ([[Dignity]] · [[Respect]] · [[Forgiveness]] · [[Reconciliation]]).

A list of what a body does not tolerate is therefore one of the more revealing documents it can write, and one of the more dangerous. Both are true, and both are reasons to write it carefully rather than not at all.

**Also called:** what we will not carry
