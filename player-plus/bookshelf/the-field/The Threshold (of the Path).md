...
It is also where the Game's ethic of attraction rather than promotion is enforced structurally. The Seed arrives through someone who trusts you — a hand, not a broadcast — and the first act asked of the arriver is to say yes in their own words where others can hear it. The terms of any room are read at its own door; nothing binds that was not read.

In the Game the Threshold is the first two stages of [[The 12 Stages of the Sovereign's Path]]: Discovery, where the Seed is first received and nothing more is required, and Threshold proper, where a person stands between worlds and chooses. In the System it is the reason every body maintains a [[Field of Agreements]] that can be read at its door before anyone steps through it.

**Also called:** Crossing Into The World
