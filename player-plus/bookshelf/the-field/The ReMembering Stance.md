...
**Teaching becomes pointing.** The elder does not hand over the Pattern; the elder helps someone notice what they already know under the noise ([[The Pedagogy of Trust and Sirimiri]], [[Guidance]], [[Asking Questions]]).

**Resonance is the signal.** *Yes — I have known this somehow, somewhere.* That recognition is the teaching working, and it is a better test than assent ([[Empirical Resonance]], [[Resonance]], [[Sensing comes before understanding]]).

**Cultural diversity becomes coherent rather than embarrassing.** Every people that touched the Pattern was remembering the same thing from its own angle, which is why the traditions can be harvested rather than ranked ([[ReHarvesting the Great Traditions]], [[Cross-Cultural Pattern Translation]], [[Meta Unity of Meta Diversity]]).

**Trauma becomes obstruction, not absence.** The bound person has not lost the Pattern; it is veiled. Healing uncovers rather than installs ([[Trauma]], [[Healing]], [[The Veil of Finitude and Forgetting]]).
...
**Also called:** ReMembering, not learning · the Pattern is recalled
