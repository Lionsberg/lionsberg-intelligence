...
Both readings share one truth worth carrying: a queue is information. Whatever is waiting — people or work — is telling a body exactly where it is too narrow. The wrong response is to hurry the people through; the right one is to widen the place, or to say honestly how long the wait is and why ([[Honesty about time]], [[Limiting Factor]]).

Its discipline in the first sense is that nobody waits invisibly. A person who has knocked and heard nothing has not been queued, they have been dropped — and a body that cannot say how many are waiting, and roughly for how long, does not have a queue at all ([[The Roll]], [[The Record]]).

It is not to be confused with a [[Cue]], which sounds identical and is an unrelated word for the opposite motion: work handed to someone already playing.

**Also called:** the waiting room
