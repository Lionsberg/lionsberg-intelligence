...
*The reading of perceived reality as an interface rather than as the thing itself — useful, faithful enough to act on, and not the underlying truth.*
...
It carries two warnings, and the second is the serious one. A thing may be an interface and still be binding: hunger, pain, and a promise made to a neighbour do not become optional because the screen is a screen. And the reading is easily conscripted into dismissing the world, the body, and other people's suffering, which is the exact inversion of everything else here — the Way is embodied, local, and practical, and any metaphysics that makes a person less present at the table has been misused ([[Embodiment]], [[Immanence]], [[Heaven On Earth]], [[Dignity]]).

**Also called:** reality as interface
