...
It was set aside because the word was carrying too much. *Ring* also names the six depths of reading in the 101 sequence, where a ring is a widening circle of a book rather than a body of tables; and a Cell is itself often called a ring of trust. A word that means a body, a reading depth, and the shape of one table cannot be relied on at the door of a stranger's page. *Supercell* says the thing plainly and borrows nothing.

The name persists in live text, which is why it is worth keeping a page. The Operating System's section on home and the plan of the whole still reads *ring*, and the Little Book's worked example *A Ring of Ten Circles* still shows ten tables reading one another's sheets in an evening. Both are sound where they stand; substitute *supercell* as you read, and nothing else changes.

**Also called:** superseded by supercell in the Little Book
