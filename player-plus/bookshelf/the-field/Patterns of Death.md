...
They are also cumulative and quiet. Almost nothing collapses in a day; it drifts, one small tolerated thing at a time, and each step is defensible in isolation ([[Drift]] · [[Quick Fixes]] · [[We Do Not Tolerate]] · [[Communication Debt]]). Which is why the response is the ordinary rhythm rather than a rescue: the weekly look-back, the defect written down, the tension mended while it is small ([[Retrospective]] · [[Mend a Tension]] · [[Improvement log]]).

The Field carries the worked instances under two other names, and this page is their family. At the scale of a person or a Cell they are the [[The Anti-Patterns|Anti-Patterns]]; at the scale of an order they are the [[Systemic Failure Modes]]. What this name adds is the stake: these are not inefficiencies but directions, and the direction ends somewhere ([[Collapse]] · [[Hell On Earth]] · [[Dying]]).

**Also called:** Pattern of Death · Patterns of Failure · the patterns that spiral down
