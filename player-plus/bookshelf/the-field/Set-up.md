...
**Also called:** setup
**Stands on:** [[Agent]] · [[Language model]] · [[Charter]] · [[Memory (agent)]]
**Opens onto:** [[Agent engineering]] · [[Safety check]] · [[Zero Blame Environment]] · [[Hosted service]] · [[Key]]
**In play:** beyond
**Sources:** Player+ Modules, *Agent Engineering*, *How an AI Agent Works*, *The Agent Improvement Process* · lionsberg.wiki: *Zero Blame Environment*, *Continuous Improvement*.
**Open:** none found.
