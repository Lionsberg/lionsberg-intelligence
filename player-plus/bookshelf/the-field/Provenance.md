...
*Every work carries its lineage: grown from, shaped by, played in, shared under.*
...
Provenance never thins. Each version is kept, changes carry their why and their source, and what one copy learns is offered back so the trail runs in both directions.
