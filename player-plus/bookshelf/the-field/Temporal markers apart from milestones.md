...
pillar: —
---
# Temporal markers apart from milestones

*The solstices and equinoxes mark time; milestones mark work. Confuse them and both stop telling the truth.*

A temporal marker is a date the sky gives: a solstice, an equinox, the turning of a season. It arrives whether or not anything is finished. It is owned by no one, adjustable by no one, and it is what lets ten thousand tables breathe on the same rhythm without any of them consulting the others.

A milestone is a date the work gives: a thing complete, to a stated quality, by a day someone has given their word for. It is steered by, replanned against, and reported honestly when it is missed.
