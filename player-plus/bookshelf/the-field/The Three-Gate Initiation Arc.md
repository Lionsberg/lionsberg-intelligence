...
pillar: —
---
# The Three-Gate Initiation Arc

*Ninety days, then three years, then seven — and each gate is passed by mutual consent rather than by completion.*

**The ninety-day trial.** A bounded first season to gauge commitment and fit. Both sides are looking: the person is finding out whether this is theirs, and the body is finding out whether the person can hold the foundational disciplines. Either may withdraw at the end without dishonour — which is what makes the ninety days a genuine trial rather than a probation with a foregone conclusion ([[90 Day Sprint]], [[Who Refuses The Call, And Is Honored]]).

**The three-year window.** If mutual consent remains, the person enters a longer formation in which the foundational skills are introduced and they are woven into the body they are joining. Three years is long enough that nothing can be performed through it and short enough to be a real commitment rather than an open horizon ([[The Three-Year Formation]], [[Apprenticeship]]).
...
**Also called:** ninety days, three years, seven years
