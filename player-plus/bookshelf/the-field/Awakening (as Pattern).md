...
---
# Awakening (as Pattern)

*Recognizing the field as it is. The first move of the inner Path, and the one that can be made only once and then must be made continually.*

Awakening is not the acquisition of information. It is the moment the field is seen without the frame that had been placed over it — the old order visible as collapsing rather than permanent, the new visible as forming rather than fantasy, others visible as already at work, and oneself visible as here, now, awake, and inside it.
...
Held as a Pattern rather than a container, it is invocable at any scale: a person wakes, and so does a Circle that finally sees what it has been avoiding, and so does a community, and so does a world. What it asks of the one who has made the move is the same in each case — that they make the next one.

**Also called:** recognizing the field as it is
