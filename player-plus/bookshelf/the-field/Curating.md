...
*Gathering what is relevant to a subject and adding value by the selecting — choosing, ordering, and then looking after what has been chosen.*
...
The discipline that keeps it honest is declaring the selection. Every curation is a set of choices, and a collection presented as though it were simply *what exists* has hidden its own editing. Say what was included, on what basis, and what was left out ([[Transparency]] · [[Gaps Not Yet Closed]] · [[Elision]] · [[Second reader]]).

And it is an act of service rather than of ownership. What is curated belongs to the people it was curated for ([[Knowledge as commons]] · [[Stewardship]] · [[Gift]]).

**Also called:** content curation
