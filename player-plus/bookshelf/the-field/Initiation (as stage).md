...
In the Game it sits between welcome and the first [[The Turn|Turn]]. A person is welcomed at the door, oriented into the Story and the Game, and then — when they choose, not when a schedule says — they step in, pledge what they will give, and take their place at a table. In the wider walk it corresponds to the choice at [[The Threshold (of the Path)]] and to [[The Decision]] that follows the whisper.

**Also called:** stepping in
