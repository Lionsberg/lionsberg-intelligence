...
**Sources:** `LIØNSBERG Wiki Books/Citizen Led Governance/2.9 The Pattern for Measuring and Quality and Quantity of Service, and Originating Units of Value` (written in the pattern form — context, problem, forces, solution, resulting context)
