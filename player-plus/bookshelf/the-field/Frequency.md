...
It is carried with a caution the Field should keep visible. The Concept Field marks Frequency and [[Vibration]] as two undefined-in-practice Root Keys, noting that [[Resonance]] and [[Attunement]] are the ones other pages actually reach for. Both appear in the Lexicon's Meta Layer as one-line entries; neither is developed on its own page; no Play or card depends on them. The vocabulary is real and in use; the concept's load is not yet demonstrated.

In play the honest form is small: a Cell noticing, out loud, that the room has gone flat or come alive, and treating that as information worth naming rather than as a claim about anyone.

**Also called:** vibrational quality · signature
