...
*The right and the mechanism to seek correction when injustice or deviation occurs — somewhere to go that is not the door.*

Recourse is what a person has when something has gone wrong and the ordinary channel is the problem. Its two halves are equally necessary: a *right* that the body recognizes, and a *mechanism* that actually functions. A right without a mechanism is a sentiment; a mechanism nobody is entitled to use is a favour.
