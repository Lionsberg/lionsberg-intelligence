...
*Turning undifferentiated information into chunks — deciding what goes on one page and what goes on another, and where the seams inside a page fall.*

You are chunking whenever you decide what belongs on this page and what belongs on that one; when you put something under a heading; when you change a heading's level; when you make a list. It looks like formatting and it is not. **It is a knowledge-design decision about the rough shape of the network** — and the shape of the network is what a reader can find, link to, and think with ([[Link concepts, not coordinates]] · [[One canonical home per concept]] · [[Name the Concept in the Singular]]).
