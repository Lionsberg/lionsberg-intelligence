...
Both kinds are real and both are needed. A backward-looking story explains where a people came from, what was done to them, and what was lost; without it there is no identity and no honest reckoning. A forward-looking story says where they are going and what it will be like when they get there. The trouble is the ratio. Billions of backward-looking stories and almost no shared forward-looking one is a fair description of the present hour, and a people with only a past organizes around grievance, because grievance is the only thing a shared past reliably supplies.
...
**Also called:** Backward-Looking Story · Billions of Backward and Forward Looking Stories
