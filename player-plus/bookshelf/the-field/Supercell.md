...
*Three or more [[Cell|Cells]] that have become one another's home; supercells form supercells.*

A supercell has no office, no officer, and no money beyond what its Cells send inward. What it has is a relationship and an evening. A young Cell's home is the Cell that carried it [[The Flame]]; when three or more Cells come to know one another — by place, or by a shared [[Quest]] — they become one another's [[Home Cell]], and that body is a supercell. It commands none of them; every Cell in it remains sovereign, and may leave ([[Sovereignty At Every Scale]], [[The Way Out]]).

The move composes without limit, and that is the point of the word. Supercells become one another's home in turn, and below a Cell its subcells do the same, so the identical card, evening, and page carry a neighbourhood, a town, and a planet without a new institution at any rung ([[Holofractal Omnifederation]], [[Cell of Cells]]). A thousand Cells make about a hundred supercells, a hundred make about ten, ten make one: four evenings, each reading a dozen pages, and ten thousand people know themselves in a single turning, in any language, because line six is line six everywhere ([[Minimum standards of interoperability]]).
