...
Every being has a right to be safe, in body, mind, spirit, home, community, and world. Self defence is the narrow ground on which force is permitted at all: not to win, not to punish, not to prevent a future someone imagines, but to stop a harm that is happening.

Three limits come with the permission. It is **bounded by sufficiency** — the minimum that restores [[Right Relationship]], ending when the harm ends, which is what separates defence from retribution. It is **bounded by discernment** — defensive and offensive force are distinguished deliberately and in advance, because under pressure nearly anyone can tell themselves a defensive story about what they already wanted to do. And it is **bounded by the earlier rungs** — detecting, naming, and withdrawing consent resolve most harm without force, and they stay available only until force is used.
