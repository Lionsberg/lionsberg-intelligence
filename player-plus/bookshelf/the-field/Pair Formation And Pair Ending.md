...
pillar: XI
---
# Pair Formation And Pair Ending

*Five things to check before two people commit to working as one — and five steps for ending it cleanly when the season closes.*

**Forming.** A pair is not assigned; it is recognised, and the recognition is felt rather than negotiated. Some pairings are immediately right, some are forced, many are neutral and stay neutral. What is checked before it is taken up:

**Mutual sovereignty** — each holds their own centre; neither is leaking into or absorbing the other ([[Sovereignty]]). **Alignment** — both are walking under the same commitments, at compatible depths; a wide gap makes a teaching relationship rather than a working pair ([[Vow-Speaking]]). **Compatibility** — the two work together easily rather than requiring constant effort to hold coherence. **Right relationship in the other dimensions** — the pair work is distorted by unresolved conflict, and any other bond between the two requires its own discipline to keep the working relationship clean. **Shared availability** — the work requires actual time together; two people may recognise a pair and be unable to operate it this season.
