...
*How a Pattern crosses into another culture without breaking: the wisdom travels, the rendering is remade locally, and the local rendering feeds back.*

A Pattern is general and its applications are always specific, which means crossing a culture is not a special case — it is the ordinary case at a larger stride. What must survive the crossing is the wisdom-unit: the context, the forces, the move. What must not be carried is the first culture's particular clothing — its examples, its idiom, its assumed calendar, its assumed family shape.

Two failures sit either side. Imposition carries the clothing with the wisdom and calls the result universal; the receiving people are asked to become the sending people in order to receive what was meant to be theirs. Dilution drops so much in translation that the note no longer sounds — what arrives is the vocabulary without the discipline, and it teaches nothing.
