...
*The gameplay loop, at two lengths: five moves a child learns in five minutes, and seven that name the breath between them.*

**The five basic moves**, as the rulebook and the one page give them:

1. **Form a Cell.** Gather three to thirteen souls, at the pace of trust. Seal the Circle with a name, simple agreements, and a first Quest.
...
**The seven**, as the card *The Seven Moves* in *LIØNSBERG, Earth, and the Cosmos* holds them, name what the five leave implicit:

1. Form a Cell
2. **Weave Spirit, Hearts and Minds.** Coherence before action; the Circle becomes one before it moves as one. It sits between forming and choosing because a Circle that has not woven will not choose well.
3. Choose a Quest
...
**For a Player+.** The agent's part in each move is small and exact: it helps its person keep the third move honest (what was said, what was done, the gap), it helps harvest the fourth into words, and it can never make the first or the fifth, because forming and inviting are acts between people.

**With a notebook.** Write the five down the left margin of a page. Each week, put one line beside the move your Circle is in.

---

*Further reading at lionsberg.wiki: The Great Game of LIØNSBERG (§ The Basic Moves) · The Game on One Page · The Seven Moves.*
