...
Player+ carries the Great Game of LIØNSBERG, the whole library that teaches it, and the seed text from which all of LIØNSBERG can be regrown — into a folder of your own, where your agent lives and remembers.
...
**It is wrong in places.** This is a first release, and it will have errors no one has found yet. It is the worst it will ever be, and it improves each week. Every defect is a gift; [`CONTRIBUTING.md`](CONTRIBUTING.md) says how to hand one back.

## What is inside

- **`bookshelf/the-dna-of-heaven/THE DNA OF HEAVEN.md`** — the seed text: Spirit · Story · the Twelve Pillars · the Pattern · the Game · the Flame · Building · the Way · the Path · Players and agents · the Plan · the Words · how to regrow and how it changes. Your agent's first reading.
- **`CLAUDE.md`** — your agent's charter: who it is, who it serves and what game it plays, the seed it carries, how it keeps you safe, how it remembers, and that anyone may call stop.
...
The canon of LIØNSBERG is at **lionsberg.wiki** and its library at **read.lionsberg.world**, both under Creative Commons Attribution-ShareAlike 4.0; the seed text and the shelves quote them and point to them.

Player+ grows from **Peter Kaminski's pkai-starter-kit v3.0.0** and the pkai-agent line before it (MPL-2.0), and stands beside that kit as a parallel line. The kit's shelves, skills, and the spine of the charter are his, carried with their own licences and lineage. [`LINEAGE.md`](LINEAGE.md) holds the full credit; [`LICENSE.md`](LICENSE.md) says what you may do.
